...
class PopularTimefreeScreen extends Component{
    state = {
        timefree: DATA.topTimefree,
    ...
    render() {
        ...
        const timefreeList = this.state.timefree.map(item => 
...
export default PopularTimefreeScreen;
